...
!function (a, b, c, d) {
        ...
        function h(g) {
            ...
            function i(a, b, d) {
                b.then(function (b) {
                    ...
                    j && j._renderer ? j._renderer.withOptions(b).render(a, g, d).then(function (a) {
                        j = a
            ...
            var j, k = this;
            k.buildOptionsPromise = h, k.render = i
        }
    ...
    function j(a) {
        function b(b, c) {
            return b.id = c.id, b.DataTable = c.DataTable, b.dataTable = c.dataTable, e[b.id] = b, g = b, h.resolve(e), f.resolve(g), h = a.defer(), f = a.defer(), h.resolve(e), f.resolve(g), b
        }
        ...
        var e = {}, f = a.defer(), g = null, h = a.defer();
        return {register: b, getLast: c, getList: d}
    }
    ...
    function q(a, b, c, d, e, f, g, h) {
        function i(i) {
            function j(a, c, e) {
                o = e, q = a, r = c.$parent, s = h.newDTInstance(t);
                var i = b.defer(), j = a.find("tbody").html(), k = j.match(/^\s*.+?\s+in\s+(\S*)\s*/), l = k[1];
                if (!k)throw new Error('Expected expression in form of "_item_ in _collection_[ track by _id_]" but got "{0}".', j);
                var m = !1;
                return r.$watchCollection(l, function () {
                    p && m && n(), d(function () {
                        m = !0;
                        var a = f.hideLoadingAndRenderDataTable(q, t.options);
                        p = a.DataTable, i.resolve(g.register(s, a))
                    }, 0, !1)
                }, !0), i.promise
            }
            ...
            function m() {
                n(), f.showLoading(q), d(function () {
                    var a = f.hideLoadingAndRenderDataTable(q, t.options);
                    p = a.DataTable, s = g.register(s, a)
                }, 0, !1)
            }

            function n() {
                p.ngDestroy(), q.html(o), c(q.contents())(r)
            }
    ...
    function r(a, b, c, e, f, g, h) {
        function i(i) {
            function j(b) {
                var c = a.defer();
                return t = h.newDTInstance(v), s = b, n(v.options.fnPromise, f.renderDataTable).then(function (a) {
                    r = a.DataTable, c.resolve(g.register(t, a))
                }), c.promise
            }

            function k() {
                d.isFunction(v.options.fnPromise) ? n(v.options.fnPromise, q) : c.warn("In order to use the reloadData functionality with a Promise renderer, you need to provide a function that returns a promise.")
            }

            function l(a) {
                v.options.fnPromise = a, n(v.options.fnPromise, q)
            }

            function m() {
                r.destroy(), f.showLoading(s), j(s)
            }
            ...
            function o(b, c) {
                ...
                return u = d.isFunction(b) ? b() : b, u.then(function (a) {
                    ...
                    u = null, e.resolve(p(v.options, s, b, c))
                }), e.promise
            }
            ...
            function q() {
                return r.clear(), r.rows.add(i.aaData).draw(), {
                    id: t.id,
            ...
            var r, s, t, u = null, v = Object.create(e);
    ...
    function s(a, b, c, e, f, g, h) {
        function i(i) {
            function j(b) {
                q = b;
                var c = a.defer(), e = h.newDTInstance(r);
                return d.isUndefined(r.options.sAjaxDataProp) && (r.options.sAjaxDataProp = f.sAjaxDataProp), d.isUndefined(r.options.aoColumns) && (r.options.aoColumns = f.aoColumns), n(r.options, b).then(function (a) {
                    p = a.DataTable, c.resolve(g.register(e, a))
                }), c.promise
            }

            function k() {
                if (p) {
                    var a = r.options.ajax.url || r.options.ajax;
                    p.ajax.url(a).load()
                }
            }

            function l(a) {
                r.options.ajax = a, r.reloadData()
            }

            function m() {
                p.destroy(), e.showLoading(q), j(q)
            }

            function n(c, d) {
                var f = a.defer();
                return c.bDestroy = !0, e.hideLoading(d), o(c) ? b(function () {
